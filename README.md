...
artist - artist of the resource, shown in second line
...
If showNotification is set as true and no title and artist is provided, then empty notification will be
displayed.
